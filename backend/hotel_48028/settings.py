"""
Django settings for hotel_48028 project.
...
WSGI_APPLICATION = 'hotel_48028.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hotel_48028 API",
    "DESCRIPTION": "API documentation for hotel_48028 App",
    "VERSION": "v1",
}
